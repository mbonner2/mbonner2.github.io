(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 0, 0.7);
        collectable.create(type.kennedi, 575, 75, 0, 0.7);
        collectable.create(type.grace, 77, 415, 1000, 0.7);
        collectable.create(type.max, 550, 330, 0, 0);
